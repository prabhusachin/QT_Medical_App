#include "expmondlg.h"
#include "ui_expmondlg.h"

ExpMonDlg::ExpMonDlg(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ExpMonDlg)
{
    ui->setupUi(this);
...
void ExpMonDlg::initializeModel(QStandardItemModel *model1)
{
...
void ExpMonDlg::on_pushButton_clicked()
{
    ...
    QSqlQuery query(db1);
    query.prepare(QString("SELECT * FROM Medicines WHERE Expirydate=:Expirydate"));
...
void ExpMonDlg::createView(QStandardItemModel *model4)
{
...
void ExpMonDlg::on_btnDelete_clicked()
{
