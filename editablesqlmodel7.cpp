...
void EditableSqlModel7::setQl(QString s)
{
    sql = s;
    return;
}

void EditableSqlModel7::setR2(int c)
{
    r = c;
    return;
}
...
QStandardItemModel* EditableSqlModel7::refresh(QStandardItemModel *model1)
{
...
//! [2]
bool EditableSqlModel7::setName(int personId, const QString &Name)
{
    QSqlQuery query;
...
bool EditableSqlModel7::setCompany(int personId, const QString &comp)
{
    QSqlQuery query;
...
bool EditableSqlModel7::setDistName(int personId, const QString &distName)
{
    QSqlQuery query;
...
bool EditableSqlModel7::setMfgDt(int personId, const QString &mfgDt)
{
    QSqlQuery query;
...
bool EditableSqlModel7::setExpDt(int personId, const QString &expDt)
{
    QSqlQuery query;
...
bool EditableSqlModel7::setPrc(int personId, const QString &prc)
{
    QSqlQuery query;
...
bool EditableSqlModel7::setStkQty(int personId, const QString &stkQty)
{
    QSqlQuery query;
