    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->btnRegister->setStyleSheet("background-color: rgb(255,237,208)");
    ui->edtFpwd->setStyleSheet("background-color: rgb(255,237,208)");
}
...
void MainWindow::on_pushButton_clicked()
{
    ...
    {        
        ...
        {
            QSqlQuery query(db);
            query.prepare(QString("select stemail,stpass from CustomerReg where stemail = :stemail and stpass = :stpass"));
