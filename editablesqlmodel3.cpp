...
//! [1]
void EditableSqlModel3::setMYr(int a,int b,int c)
{
    catid1 = a;
    yr1 = b;
    r1 = c;
...
int EditableSqlModel3::getCid1()
{
    return catid1;
}

int EditableSqlModel3::getYr1()
{
    return yr1;
}

int EditableSqlModel3::getR1()
{
    return r1;
}
...
QStandardItemModel* EditableSqlModel3::refresh(QStandardItemModel *model1,int m, int yr)
{
    QString val = "";
    QString val1 = "";
    QString val2 = "";
    ...
    for(int m=1;m<=12;m++)
    {
        ...
        QSqlQuery query(db);
        query.prepare(QString("SELECT * FROM Medicines WHERE CategoryId=:CategoryId and mfgdate=:mfgdate"));
...
//! [2]
bool EditableSqlModel3::setName(int personId, const QString &Name)
{
    QSqlQuery query;
...
bool EditableSqlModel3::setCompany(int personId, const QString &comp)
{
    QSqlQuery query;
...
bool EditableSqlModel3::setDistName(int personId, const QString &distName)
{
    QSqlQuery query;
...
bool EditableSqlModel3::setMfgDt(int personId, const QString &mfgDt)
{
    QSqlQuery query;
...
bool EditableSqlModel3::setExpDt(int personId, const QString &expDt)
{
    QSqlQuery query;
...
bool EditableSqlModel3::setPrc(int personId, const QString &prc)
{
    QSqlQuery query;
...
bool EditableSqlModel3::setStkQty(int personId, const QString &stkQty)
{
    QSqlQuery query;
